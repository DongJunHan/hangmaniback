...
//                    (file, savedFileName, requestDTO.getStoreUuid(), uploadTime);
            ...
            int i = fileRepository.insertAttachment(AttachmentDTO.builder()
                    .savedFileName(savedFileName)
                    .storeUuid(requestDTO.getStoreUuid())
    ...
    public List<AttachmentDTO> getAttachmentsByUuid(String storeUuid) {
